  ...
  return (
    <>
      ...
      <div className="flex w-full pl-14 mt-10 justify-between">
        <h1>
          <span className=" text-6xl md:text-8xl font-bold text-secondary">
            CARRERAS
          </span>
          <span
            className="underline text-5xl md:text-7xl font-bold text-accent  w-fit"
        ...
        <img className="w-2/12 -translate-y-10" src={RouteMapImg} alt="Mapa de rutas" />
      </div>
